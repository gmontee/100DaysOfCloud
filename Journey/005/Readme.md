<div id="cover photo" align="center">
  <img src="https://media.giphy.com/media/UDGHSuv6ZZRpUInXzL/giphy.gif" width="300"/>
</div>
...
<div id="use case" align="center">
  <img src="https://microsoftlearning.github.io/AZ-104-MicrosoftAzureAdministrator/Instructions/media/lab03a.png" width="400"/>
</div>
...
<div align="center">
  <img src="images/az104-lab3a-task1-create-disk.png" width="800"/>
</div>
...
<div align="center">
  <img src="images/az104-lab3a-task2-move-disk.png" width="800"/>
</div>

A little annoying having to wait a few minutes for the "Next" button to be enabled while the check was going on.

<div align="center">
  <img src="images/az104-lab3a-task2-move-check.png" width="800"/>
</div>
...
<div align="center">
  <img src="images/az104-lab3a-task3-delete-failed.png" width="800"/>
</div>
...
<div align="center">
  <img src="images/az104-lab3a-task3-resize-disk.png" width="800"/>
</div>

## ☁️ Cloud Outcome

☁️ I noticed when creating disks Azure defaults to a Premium SDD 1024 GiB. Isn't that nice of Microsoft, wanting the best for me? :)

☁️ CAUTION: When removing the resource lock on the disk, I wasn't prompted. It just did. Something to keep in mind for folks, like me, who like to click things.

☁️ In cleaning up, I deleted the three new resource groups I created. The second one resource group had the first disk I created. When I was deleting that resource group, it prompted me to type the name of it, and it also displayed all the associated resources with that group, which I felt was helpful.

## Next Steps

Tomorrow, I'm going to do the fifth lab, [3b Manage Azure resources by Using the ARM Templates](../006/Readme.md), from the Azure Administration module.
